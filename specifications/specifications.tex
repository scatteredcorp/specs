...
\makeatletter
    \begin{titlepage}
        \begin{center}
            ...
            \large{réalisé par\\[2ex]aurele.oules  •  leo.gervoson  •  raphael.brenn  •  frederic.dong}\\[16ex] 
...
\begin{tabular}{ |c|c|c|c|c|} 
 \hline
    \boldblack{Tâche} & \boldblack{Aurèle} & \boldblack{Léo} & \boldblack{Raphaël} \\ 
     \hline
    Génération clés privées (ECDSA) & second & \bold{principal} &  \\ 
     \hline
    ...
    Signature contrats & second & \bold{principal} &  \\ 
     \hline
    Command Line Interface (CLI) & \bold{principal} & & second \\ 
     \hline
    ...
    Memory Pool & second & \bold{principal} &  \\ 
     \hline
     Application des règles du jeu (consensus) & second & & \bold{principal} \\ 
     \hline
    ...
    Menus du jeu & & second & \bold{principal}\\ 
     \hline
    Interface de selection de billes & \bold{principal} & & second\\ 
     \hline
     Modélisation 3D des obstacles & second & & \bold{principal} \\ 
     \hline
     Création du plateau de jeu (avec seed) & & second & \bold{principal} \\ 
     \hline
      Lancement de la bille & \bold{principal} & & second \\ 
    \hline
       Physique deterministe (Unity DPhysics) & \bold{principal} & second & \\ 
     \hline
    Détection collision de victoire & \bold{principal} & second &\\ 
     \hline
    Site web & \bold{principal} & &\\ 
     \hline
\end{tabular}
\end{center}
...
\begin{tabular}{ |c|c|c|c|} 
 \hline
    ...
    \hline
     ...
     \hline
        Communication TCP/IP & 50\% & 80\% & \bold{100\%} \\ 
     \hline
